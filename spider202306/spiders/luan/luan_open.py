...
payload = "{\"token\":\"\",\"pn\":0,\"rn\":10,\"sdt\":\"\",\"edt\":\"\",\"wd\":\"\",\"inc_wd\":\"\",\"exc_wd\":\"\",\"fields\":\"title\",\"cnum\":\"001\",\"sort\":\"{'webdate':'0'}\",\"ssort\":\"title\",\"cl\":500,\"terminal\":\"\",\"condition\":[{\"fieldName\":\"categorynum\",\"isLike\":true,\"likeType\":2,\"equal\":\"001001012\"}],\"time\":[{\"fieldName\":\"webdate\",\"startTime\":\"1970-01-01 00:00:00\",\"endTime\":\"2999-12-31 23:59:59\"}],\"highlights\":\"\",\"statistics\":null,\"unionCondition\":[],\"accuracy\":\"\",\"noParticiple\":\"0\",\"searchRange\":null,\"isBusiness\":\"1\"}\r\n"
...
for i in range(50):
    ...
    for project in projects['result']['records']:
        ...
        tenderer_num = len(get_bidder_list(html_text, '投标人'))
        print(tenderer_num)
        data = pd.DataFrame(data=[[id,title, relationguid, link_url, tenderer_num]],
                            columns=['id','项目名称', '关系id', '开标公告网址', '投标单位数量'])
        df = pd.concat([df, data])
        sleep(random.randint(1, 5))
df.to_excel(f'六安市开标记录公告信息{t}.xlsx', index=False)
